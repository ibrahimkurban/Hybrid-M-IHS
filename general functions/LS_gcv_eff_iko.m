function [x_ls_gcv, par, dev_est,time, obj, lambdas] = LS_gcv_eff_iko(U, sig,V,b, x1, nn)
%%LS_GCV_EFF calcualtes RegLS solutionwith paramter found via GCV of
%%G.Golub, but uses projected version.
%
%   Author  : Ibrahim Kurban Ozaslan
%   Date    : 14.07.2018
%   v2      : finds lambda by fminbnd
%
%   [x_ls_gcv, par_ls_gcv, obj_ls_gcv_par, lambdas_ls_gcv] = LS_gcv(A,b, x1,nn)
%
%   x1 : prior
%
